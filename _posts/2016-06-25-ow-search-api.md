...
- Science
---
守望先锋（ow）全球开服也有一段时间了，作为一个创意并不新鲜的游戏，暴雪无疑是非常成功的，玩家数直破10 million

这种半休闲游戏不同于CSGO，外加战网的ID系统比Steam更加具有确定性，所以各大网站的OW查询系统分上线，这时候，不正是偷api的好时机嘛？不对不对，读书人的事，怎么能叫偷呢？

毕竟暴雪暂时没有开放api，查询还不够准确

更新：国服只能查询自己登陆账号的数据了，接口作废。
